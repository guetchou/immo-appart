...
export async function POST(request: NextRequest) {
  ...
  const globalModels = ['homepage', 'navigation', 'footer-config', 'site-config', 'catalogue-config', 'reseaux-sociaux', 'page-a-propos', 'page-paiement', 'page-reglement', 'politique-annulation']
